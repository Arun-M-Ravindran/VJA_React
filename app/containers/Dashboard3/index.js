...
export default class Dashboard3 extends React.Component { // eslint-disable-line react/prefer-stateless-function
                    ...
                    <div className="ibox float-e-margins">
                       <div className="ibox-title">
                        ...
                        <div className="ibox-content">
                            <div className="row">
                              <div className="col-sm-4"><PieChart data={chartData}  width="100" height="100"/></div>
